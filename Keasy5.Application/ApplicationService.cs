...
using Keasy5.Application.Mapping;
using Keasy5.Domain;
...
namespace Keasy5.Application
{
    ...
    public abstract class ApplicationService : DisposableObject
    {
        ...
        protected void PerformDeleteObjects<TAggregateRoot>(IDList ids, 
            IRepository<TAggregateRoot> repository, 
            Action<Guid> preDelete = null, 
            Action<Guid> postDelete = null)
            where TAggregateRoot : class, IAggregateRoot
        {
            if (ids == null)
        ...
        {
            //配置DTO和DomainModel的映射，使用的是AutoMapper框架
